...
<details>
<summary>1. JWT (JSON Web Token) 사용</summary>
...
<details>
<summary>5. 리프레시 토큰의 유효기간 관리</summary>
...
### **실시간 알림 기능 구현**SSE(Server-Sent Events)를 사용
